    ...
    <section class="mt-2 mb-5 sm:flex">
        <section class="sm:w-2/3 max-h-[55px]">
            <img class="lazy" src="{{ asset('app-assets/images/discount-loader.webp') }}" data-src="{{ asset('app-assets/images/001212-coupon-first-shop2.webp') }}" alt=""
                class="sm:h-full min-h-[30px]">
        </section>
        <section class="sm:w-1/3 flex p-3 max-h-[55px] items-center bg-blue-300">
            <section class="flex flex-col items-center w-1/2 px-3 py-1 border border-gray-700 border-dashed rounded-md">
            ...
            <section class="flex items-center justify-center w-1/2">
                <span class="text-2xl text-gray-700">11:10:09</span>
            </section>
        </section>
    </section>
