        ...
        <section class="md:flex block gap-6">
            <section class="w-full md:w-3/12">
                ...
                <section class="mt-10 flex flex-wrap gap-1">
                    ...
                    <a href="" class="flex gap-2 items-center px-4 py-2 bg-gray-800 border rounded-md font-semibold text-xs text-white focus:outline-none focus:ring ring-gray-300 transition ">
