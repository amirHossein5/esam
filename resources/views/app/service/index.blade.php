        ...
        <section class="grid grid-cols-1 gap-8 md:grid-cols-2">
            ...
            <section>
                ...
                <div class="flex flex-col mt-3">
                    <a href="" class="py-4 text-sm text-gray-600 border-t a-hover first:border-t-0">چگونه خرید کنم و در مزایدات شرکت کنم؟</a>
                    <a href="" class="py-4 text-sm text-gray-600 border-t a-hover first:border-t-0">چگونه خرید کنم و در مزایدات شرکت کنم؟</a>
                    <a href="" class="py-4 text-sm text-gray-600 border-t a-hover first:border-t-0">چگونه خرید کنم و در مزایدات شرکت کنم؟</a>
                    <a href="" class="py-4 text-sm text-gray-600 border-t a-hover first:border-t-0">چگونه خرید کنم و در مزایدات شرکت کنم؟</a>
                </div>
                ...
                <div class="flex flex-col mt-6 gap-7">
                    <div class="cursor-pointer drop-list" data-open="false">
                        ...
                        <div class="hidden mt-3 drop-list-zone">
                            <a href="" class="block py-4 text-sm text-gray-600 border-t a-hover first:border-t-0">چگونه خرید کنم و در مزایدات شرکت کنم؟</a>
                            <a href="" class="block py-4 text-sm text-gray-600 border-t a-hover first:border-t-0">چگونه خرید کنم و در مزایدات شرکت کنم؟</a>
                            <a href="" class="block py-4 text-sm text-gray-600 border-t a-hover first:border-t-0">چگونه خرید کنم و در مزایدات شرکت کنم؟</a>
                            <a href="" class="block py-4 text-sm text-gray-600 border-t a-hover first:border-t-0">چگونه خرید کنم و در مزایدات شرکت کنم؟</a>
                        </div>
