        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="pb-2 mt-4 mb-3 border-bottom">
                    <a href="{{ route('admin.ticket.periorities.create') }}" class="btn btn-info btn-sm">
                        ایجاد اولویت

                    </a>
                    <a href="{{ route('admin.ticket.periorities.archive') }}" class="mx-2">
                        <u>آرشیو</u>
                    </a>
                </section>
    ...
    <script>
        $(function() {
            $('#table').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                'ajax': "{{ route('admin.ticket.periorities.index') }}",
                "columns": [{
                        "data": "id",
                    ...
                    {
                        "render": function(data, type, row, meta) {
                            var deleteRoute = "{{ route('admin.ticket.periorities.destroy', ':id') }}"
                                .replace(':id', row.id);
                            var editRoute = "{{ route('admin.ticket.periorities.edit', ':id') }}"
                                .replace(':id', row.id);
