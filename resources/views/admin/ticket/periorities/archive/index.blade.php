...
@section('head-tag')
    <title>آرشیو اولویت تیکت ها </title>
...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page">آرشیو اولویت تیکت ها </li>
        </ol>
    </nav>
        ...
        <section class="col-12">
            <section class="main-body-container">
                <section class="main-body-container-header">
                    <h5>
                        آرشیو اولویت تیکت ها
                    </h5>
                </section>

                <section class="pb-2 mt-4 mb-3 border-bottom">
                    <a href="{{ route('admin.ticket.periorities.index') }}" class="btn btn-info btn-sm">
                        بازگشت
                    </a>
                </section>
    ...
    <script>
        $(function() {
            $('#table').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                'ajax': "{{ route('admin.ticket.periorities.archive') }}",
                "columns": [{
                        "data": "id",
                    ...
                    {
                        "render": function(data, type, row, meta) {
                            var forceDeleteRoute = "{{ route('admin.ticket.periorities.forceDelete', ':id') }}"
                                .replace(':id', row.id);
                            var restoreRoute = "{{ route('admin.ticket.periorities.restore', ':id') }}"
                                .replace(':id', row.id);
