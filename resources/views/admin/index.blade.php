...
@section('content')
    ...
    <section
        class="d-flex rounded justify-content-center bold "
        style="align-items: center;height: calc(100% - 10rem); font: bolder; font-size: 22px; background-color: rgb(209 213 219); color: rgb(150 150 150)"
    >
        پنل ادمین
    </section>
