        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="pb-2 mt-4 mb-3 d-flex justify-content-between align-items-center border-bottom">
                    <div>
                        <a href="{{ route('admin.market.selectableAttributes.create') }}" class="btn btn-info btn-sm">
        ...
        $(document).ready( function () {
            $('#table').DataTable({
                ...
                "columns": [
                    ...
                    {
                        "render": function(data, type, row, meta) {
                            var editRoute = "{{ route('admin.market.selectableAttributes.edit', ':id') }}";
                            var deleteRoute = "{{ route('admin.market.selectableAttributes.destroy', ':id') }}";

                            return `
                                <section class="text-left">
                                    <a href="${editRoute.replace(':id', row.id)}" class="btn btn-warning btn-sm"
                                    >
                                        ایجاد مقدار
                                    </a>
