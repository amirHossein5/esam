        ...
        $(function () {
            $('#table').DataTable({
                ...
                "columns": [
                    ...
                    {
                        "render": function(data, type, row, meta) {
                            var returnRoute = "{{ route('admin.market.payment.return', ':id')}}"
                                .replace(':id', row.id);
                            var rejectRoute = "{{ route('admin.market.payment.reject', ':id')}}"
                                .replace(':id', row.id);
                            var paidRoute = "{{ route('admin.market.payment.paid', ':id')}}"
                                .replace(':id', row.id);
                            var notPaidRoute = "{{ route('admin.market.payment.notPaid', ':id')}}"
                                .replace(':id', row.id);
