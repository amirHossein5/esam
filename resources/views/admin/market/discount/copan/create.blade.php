                                ...
                                <div class="form-group">
                                    ...
                                    <select name="amount_type" id="amount_type" class="form-control form-control-sm">
                                        <option value="{{ App\Models\Market\Copan::PERCENTAGE }}"
                                            @if(old('amount_type') == App\Models\Market\Copan::PERCENTAGE) selected @endif
                                        >
                                            درصدی
                                        </option>
                                        <option value="{{ App\Models\Market\Copan::PRICEUNIT }}"
                                            @if(old('amount_type') == App\Models\Market\Copan::PRICEUNIT) selected @endif
                                        >
                                            تومان
                                        </option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" id="type" id="type" class="form-control form-control-sm">
                                        <option value="{{ App\Models\Market\Copan::PUBLIC }}"
                                            @if (old('type') == App\Models\Market\Copan::PUBLIC) selected @endif
                                        >
                                            عمومی
                                        </option>
                                        <option value="{{ App\Models\Market\Copan::PRIVATE }}"
                                            @if (old('type') == App\Models\Market\Copan::PRIVATE) selected @endif
                                        >
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="select2" class="form-control form-control-sm user_id_selection">
                                        ...
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}" @if($user->id == old('user_id')) selected @endif>{{ $user->first_name . '' . $user->last_name }}</option>
                                        @endforeach
                                    </select>
