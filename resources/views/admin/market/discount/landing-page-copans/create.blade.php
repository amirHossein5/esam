...
@section('head-tag')
    <title>ایجاد کپن های تخفیف صفحه اصلی</title>
...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page"> ایجاد کپن های تخفیف صفحه اصلی</li>
        </ol>
    </nav>
    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="{{ route('admin.market.discount.landingPageCopans.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="copan_id" id="copan_id" value="{{ old('copan_id') }}">
                                    ...
                                    <select id="select2" class="form-control form-control-sm copan_id_selection">
                                        ...
                                        @foreach ($copans as $copan)
                                            <option value="{{ $copan->id }}" @if($copan->id == old('copan_id')) selected @endif>
                                                {{ $copan->code }}
                                            </option>
                                        @endforeach
                                    </select>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            var time = $('#start-date-main-datepicker').val() ? parseInt($('#start-date-main-datepicker').val()) :
                null;
            dp.setDate(time)
        });
    </script>
    ...
    <script>
        $(document).ready(function() {
            ...
            var time = $('#end-date-main-datepicker').val() ? parseInt($('#end-date-main-datepicker').val()) :
                null;
            dp.setDate(time)
        });
    </script>
