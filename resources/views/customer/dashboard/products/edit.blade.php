    ...
    <section class="p-2 pt-0 bg-white border rounded-md shadow-md md:w-9/12">
        ...
        <section class="p-3">
            ...
            <div class="mt-5">
                ...
                <section class="p-2">
                     <form action="{{ route('customer.dashboard.products.update', $product->id) }}" id="form" method="post" enctype="multipart/form-data">
                        @csrf @method('put')
                        <section class="row">
                            ...
                            <section class="w-full md:w-1/2 p-1 ">
                                <div class="mb-4">
                                    ...
                                    <x-input type="text" id="name" value="{{ $product->name }}" name="name" class="w-full" />
                            ...
                            <section class="w-full md:w-1/2 p-1 ">
                                <div class="mb-4">
                                    ...
                                    <x-input type="text" name="introduction" value="{{ $product->introduction }}" id="introduction" class="w-full" />
                            ...
                            <section class="w-full md:w-1/2 p-1">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="hidden" value="{{ $product->published_at }}" id="main-date-picker" name="published_at">
                            ...
                            <section class="w-full">
                                <div class="mb-4">
                                    ...
                                    <x-textarea name="description" id="description"  class="w-full" rows="6">{{ $product->description }}</x-textarea>
                            ...
                            <section class="w-full row" id="{{ $sellTypes[0]->name }}" style="display: none">
                                <section class="w-full ">
                                    <div class="mb-4">
                                        ...
                                        <div class="mt-2">
                                            <input type="checkbox" class="!w-4 !h-4 rounded" name="has_request_for_discount" value="1" id="has_request_for_discount" @checked($product->has_request_for_discount) >
                            ...
                            <section class="w-full row" id="{{ $sellTypes[1]->name }}" style="display: none">
                                <section class="w-full">
                                    <div class="mb-4">
                                        ...
                                        <x-input type="text" id="start_price" name="start_price" value="{{ $product->auction?->start_price_readable }}"  class="w-full" />
                                ...
                                <section class="w-full">
                                    <div class="mb-4">
                                        <input type="checkbox" class="!h-4 !w-4 rounded" id="urgent_price" onchange="active_input()"
                                        ...
                                        <input
                                            type="text"
                                            name="urgent_price"
                                            class="mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 placeholder:text-sm h-[35px] disabled:bg-gray-200"
                                            @disabled(!$product->auction?->urgent_price)
                                            value="{{ $product->auction?->urgent_price_readable }}"
                                        />
                                ...
                                <section class="w-full">
                                    <div class="mb-4">
                                        <input type="checkbox" class="!h-4 !w-4 rounded" id="reserved_price" onchange="active_input()"
                                        ...
                                        <input
                                            ...
                                            name="reserved_price"
                                            class="mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 placeholder:text-sm h-[35px] disabled:bg-gray-200"
                                            @disabled(!$product->auction?->reserved_price)
                                            value="{{ $product->auction?->reserved_price_readable }}"
                                        />
                            ...
                            <div class="mb-4">
                                ...
                                <x-select name="weight_id" id="weight" class="calculate_delivery_amount w-full rtl">
                                    ...
                                    @foreach ($productWeights as $weight)
                                        <option
                                            value="{{ $weight->id }}"
                                            @selected($weight->id == $product->weight_id)
...
@section('scripts')
    ...
    <script>
        $(function(){
            ...
            $('[for=deliveryIsFree-{{ $product->deliveryIsFree }}]')[0].click()
            $($('[for=deliveryIsFree-{{ $product->deliveryIsFree }}]')[0]).addClass('text-white')
        })
    </script>
    ...
    <script class="be-reload">
        ...
        $('#form').submit(function () {
            ...
            $.ajax({
                type: "post",
                url: "{{ route('customer.dashboard.products.update', $product->id) }}",
                data: data,
                processData: false,
                contentType: false,
                headers: {
