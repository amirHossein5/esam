            ...
            <section class="py-3 d-flex justify-content-between align-items-center">
                <section class="">
                    <a class="text-decoration-none" href="index.html">
                        <img src="{{ asset('auth-assets/images/logo/8.png') }}" alt="logo">
                    </a>
                </section>
                ...
                <section>
                    ...
                    <section class="header-cart d-inline ps-3 border-start position-relative">
                        ...
                        <section class="header-cart-dropdown">
                            <section class="p-2 border-bottom d-flex justify-content-between">
                            ...
                            <section class="header-cart-dropdown-body">
                                ...
                                <section
                                    ...
                                    <section class="flex-shrink-1"><a class="p-1 text-muted text-decoration-none"
                            ...
                            <section
                                class="p-2 header-cart-dropdown-footer border-top d-flex justify-content-between align-items-center">
                                <section class="">
        ...
        <section class="container-xxl ">
            <nav class="">
                <section class="d-flex justify-content-start position-relative">
                    ...
                    <section class="mx-1 my-2 border-start"></section>
