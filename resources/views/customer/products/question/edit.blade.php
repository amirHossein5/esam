...
@section('content')
    <section class="p-4">
        <section class="p-5  bg-white border">
            ...
            <form action="{{ route('customer.product.question.update', [$question->id,$product->id]) }}" class="mt-5" method="post">
                @csrf @method('put')
                ...
                <section class="w-full md:w-1/2">
                    ...
                    <section class="flex flex-wrap gap-3">
                        <x-input type="text" name="text" class="flex-grow" value="{{ old('text', $question->text) }}" />
