...
function toggleDropdown(element) {
    if ($(element).hasClass('sidebar-group-link-active')) {
           $(element).removeClass('sidebar-group-link-active');
           $(element).children('.sidebar-dropdown-toggle').children('.angle').removeClass('fa-angle-down');
           $(element).children('.sidebar-dropdown-toggle').children('.angle').addClass('fa-angle-left');
       } else {
        $(element).addClass('sidebar-group-link-active');
        $(element).children('.sidebar-dropdown-toggle').children('.angle').removeClass('fa-angle-left');
        $(element).children('.sidebar-dropdown-toggle').children('.angle').addClass('fa-angle-down');
      }
}
